...
function FeedbackForm() {
    ...
    const feedback_type = {
        'qos': 'Please rate how our site experience from our competitors.', 
        'qob': 'Please rate the quality of services provided.',
        'roc': 'Was our site easy to use?',
        'exp': 'Please rate your overall user experience.'
    };
            ...
            (<Card>
                <Card.Header>
                    <cite title="Source Title">We are committed to providing you with the best
                        visualization experience possible, so we welcome your comments.
                    </cite>
                </Card.Header>
                <Card.Body>
